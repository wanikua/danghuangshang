...
cat > "$CONFIG_DIR/$CONFIG_FILE" << FEISHU_EOF
{
  ...
  "agents": {
    ...
    "list": [
      ...
      { "id": "hubu", "name": "户部", "workspace": "$HOME/clawd-hubu", "model": { "primary": "your-provider/strong-model" }, "identity": { "theme": "你是户部尚书，专精财务分析。回答用中文。" }, "sandbox": { "mode": "off" } },
      { "id": "libu", "name": "礼部", "workspace": "$HOME/clawd-libu", "model": { "primary": "your-provider/fast-model" }, "identity": { "theme": "你是礼部尚书，专精品牌营销。回答用中文。" }, "sandbox": { "mode": "off" } },
      { "id": "gongbu", "name": "工部", "workspace": "$HOME/clawd-gongbu", "model": { "primary": "your-provider/fast-model" }, "identity": { "theme": "你是工部尚书，专精 DevOps 运维。回答用中文。" }, "sandbox": { "mode": "off" } },
      { "id": "libu2", "name": "吏部", "workspace": "$HOME/clawd-libu2", "model": { "primary": "your-provider/fast-model" }, "identity": { "theme": "你是吏部尚书，专精项目管理。回答用中文。" }, "sandbox": { "mode": "off" } },
      { "id": "xingbu", "name": "刑部", "workspace": "$HOME/clawd-xingbu", "model": { "primary": "your-provider/fast-model" }, "identity": { "theme": "你是刑部尚书，专精法务合规。回答用中文。" }, "sandbox": { "mode": "all", "scope": "agent" }, "runTimeoutSeconds": 300 },
      {
        "id": "hanlin_zhang",
        "name": "翰林院·掌院学士",
